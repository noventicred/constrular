      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="space-y-6 md:space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 pt-6 md:pt-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-sm md:text-base">Entrega Rápida</h3>
                  <p className="text-xs md:text-sm text-muted-foreground">Em até 24h</p>
                </div>
              </div>
              
              <div className="flex items-center gap-3">
                <div className="h-10 w-10 md:h-12 md:w-12 bg-secondary/10 rounded-lg flex items-center justify-center">
                  <Shield className="h-5 w-5 md:h-6 md:w-6 text-secondary" />
                </div>
                <div>
                  <h3 className="font-semibold text-sm md:text-base">Garantia Total</h3>
                  <p className="text-xs md:text-sm text-muted-foreground">Produtos certificados</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-sm md:text-base">Pagamento Fácil</h3>
                  <p className="text-xs md:text-sm text-muted-foreground">Até 12x sem juros</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative order-first lg:order-last">
            ...
            {/* Floating offer card */}
            <div className="absolute -bottom-4 -left-4 md:-bottom-6 md:-left-6 bg-white p-4 md:p-6 rounded-lg shadow-xl border">

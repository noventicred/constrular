                  ...
                  <div className="relative h-48 md:h-56 overflow-hidden rounded-t-2xl">
                    ...
                    {product.original_price && product.original_price !== product.price && (
                      <>
                        ...
                        <Badge className="absolute top-3 right-3 md:top-4 md:right-4 bg-green-600 text-white font-bold text-sm md:text-base px-3 md:px-4 py-1 md:py-2 shadow-xl border-0 rounded-xl">
                          PIX
                        </Badge>
                      </>
                    )}
